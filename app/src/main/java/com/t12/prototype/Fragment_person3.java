...
public class Fragment_person3 extends Fragment {
    ...
    public static Fragment_person3 newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        person_fragment_title_textView.setText("할머니");
        ...
        alone_view_all_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((MainActivity)getActivity()).view_all_fragment = "person3_alone";
        ...
        together_view_all_text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((MainActivity)getActivity()).view_all_fragment = "person3_together";
                ((MainActivity) getActivity()).replaceFragment(Fragment_ViewAll.newInstance());
            }
        });
